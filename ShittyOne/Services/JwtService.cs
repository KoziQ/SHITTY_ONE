...
namespace ShittyOne.Services
{
    ...
    public class JwtService : IJwtService
    {
        ...
        public ClaimsIdentity GenerateClaimsIdentity(string email, Guid id, string securityStamp, IList<Claim> claims = null)
        {
        ...
        public string GenerateToken(ClaimsIdentity identity)
        {
            ...
            claims.AddRange(identity.Claims.Where(c => c.Type != JwtRegisteredClaimNames.Jti && c.Type != JwtRegisteredClaimNames.Iat).ToList());
            ...
            var token = new JwtSecurityToken(
                ...
                claims: claims,
                signingCredentials: new SigningCredentials(new SymmetricSecurityKey(Encoding.ASCII.GetBytes(_jwtOptions.SecretKey))
        ...
        public ClaimsPrincipal PrincipalFromToken(string token)
        {
            ...
            if((securityToken as JwtSecurityToken) is null || !(securityToken as JwtSecurityToken).Header.Alg.Equals(SecurityAlgorithms.HmacSha256, StringComparison.InvariantCultureIgnoreCase))
            {
