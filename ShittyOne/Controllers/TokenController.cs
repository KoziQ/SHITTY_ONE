...
public class TokenController : Controller
{
    ...
    public TokenController(IJwtService jwtService, IOptions<JwtOptions> options, UserManager<User> userManager,
        AppDbContext dbContext, RoleManager<IdentityRole<Guid>> roleManager)
    {
